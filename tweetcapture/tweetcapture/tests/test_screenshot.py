...
class TestScreenshot(unittest.TestCase):
    ...
    def test_screenshot1(self):
        ...
        print("Checking similarity with test images...")
    ...
    def test_screenshot2(self):
        ...
        print("Screenshot test2 started.")
    ...
    def test_screenshot_hidephotos(self):
        ...
        print("Screenshot hide photos test started.")
        ...
        template = cv2.imread("../assets/test/hidephotos/image.png", 0)
        try:
            result = cv2.matchTemplate(gray, template, cv2.TM_CCOEFF_NORMED)
        except cv2.error as err:
            raise err
        ...
        assert (is_exist == expect), "Screenshot has a photo, it is not matching with template"
    ...
    def test_screenshot_hidegifs(self):
        ...
        print("Screenshot hide gifs test started.")
        ...
        template = cv2.imread("../assets/test/hidegifs/image.png", 0)
        try:
            result = cv2.matchTemplate(gray, template, cv2.TM_CCOEFF_NORMED)
        except cv2.error as err:
            raise err
        ...
        print(f"Screenshot checked: %%%.2g Expect: {expect} Result: {is_exist}" % m)
        assert (is_exist == expect), "Screenshot has a gif, it is not matching with template"
    ...
    def test_screenshot_hidevideos(self):
        ...
        print("Screenshot hide videos test started.")
        ...
        print("Checking screenshot height...")

        image= cv2.imread(filename)
        h, _, _ = image.shape
        assert (h < 400), "Screenshot has a video"
    ...
    def test_screenshot_hidequotes(self):
        ...
        print("Screenshot hide quotes test started.")
        ...
        template = cv2.imread("../assets/test/hidequotes/image.png", 0)
        try:
            result = cv2.matchTemplate(gray, template, cv2.TM_CCOEFF_NORMED)
        except cv2.error as err:
            raise err
        ...
        print(f"Screenshot checked: %%%.2g Expect: {expect} Result: {is_exist}" % m)
        assert (is_exist == expect), "Screenshot has a quote, it is not matching with template"
    ...
    def test_screenshot_showparent(self):
        ...
        print("Screenshot show parent tweet test started.")
        ...
        template = cv2.imread("../assets/test/sp/image.png", 0)
        try:
            result = cv2.matchTemplate(gray, template, cv2.TM_CCOEFF_NORMED)
        except cv2.error as err:
            raise err
        ...
        print(f"Screenshot checked: %%%.2g Expect: {expect} Result: {is_exist}" % m)
        assert (is_exist == expect), "Screenshot has not a parent tweet, it is not matching with template"
    ...
    def test_screenshot_showmentions(self):
        ...
        print("Screenshot show mentions test started.")
        ...
        template = cv2.imread("../assets/test/sm/image.png", 0)
        try:
            result = cv2.matchTemplate(gray, template, cv2.TM_CCOEFF_NORMED)
        except cv2.error as err:
            raise err
        ...
        assert (count == expect_count), "Screenshot has not a mention, it is not matching with template"
