...
def main(time_diff, mahsa_message, gpt_suggestions_rate, reference_snapshot, num_tweets_to_preserve):
    ...
    suggestions_bot = TelegramSuggestedTweetsBot(creds, twitter_api, db_log, time_diff, gpt_suggestions_rate, reference_snapshot)
    admin_bot = TelegramAdminBot(creds, twitter_api, db_log, suggestions_bot, time_diff, mahsa_message, gpt_suggestions_rate, num_tweets_to_preserve, reference_snapshot) 
